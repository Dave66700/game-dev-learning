...
维护正确的敌人计数：确保生成器知道当前有多少敌人

实现动态平衡：死亡后补充新敌人，保持挑战性


## Step 3 — 敌人死亡时通知 Spawner
...
**然后在 DeathSequence 里 Destroy 之前 加：**
...
把场景里的 Enemy 拖到 Project 面板 → 变成 Prefab

选中 EnemySpawner

把 Enemy Prefab 拖到 Enemy Prefab 槽位
